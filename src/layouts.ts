...
export const sources = [
  {
    ...
    items: [
      ...
      { label: 'Engineering', url: 'https://www.helloprima.com/careers/departments/engineering' },
      { label: 'Growth & Development', url: 'https://www.helloprima.com/careers/growth-and-development' },
      { label: 'Jobs / Hiring', url: 'https://www.helloprima.com/careers/jobs' },
      { label: 'Senior Python Software Engineer', url: 'https://www.helloprima.com/careers/jobs/senior-python-software-engineer-77dc9214-4ed8-470e-93b0-4de8bbb1ccc4' },
    ],
  },
  {
